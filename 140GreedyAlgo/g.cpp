...
Sol:
Here we are going to use min heap to find the top 2 length of robes, which will be combine to generate a thrid
rope which we will push back again in the heap, also during this keep track of the cost.
 */
