...
/*
Apporach 1: Not optimized we are traversing each element at once and cal the remainders
*/
class Solution {
public:
...
Here we are cal. the entire need of the chalks and once and finding the reminders if there is any 
and using that same remainder to find the index which will need to replace.
*/
class Solution {
public:
    int chalkReplacer(vector<int>& chalk, int k) {
